        ...
        <div class="flex flex-col items-center justify-between lg:flex-row py-16">
            <div class=" relative ">
                <div class=" absolute top-0 -left-48 z-0  opacity-50 ">
                    <img src="https://dlds.cl/img/dlds-distribuidores-logo-1704289714.jpg" class="w-36 z-0  h-full    object-fill fill-y text-y   ">
                </div>
                <div class="lg:max-w-xl lg:pr-5 relative z-40">
                    <p class="flex text-sm uppercase text-g1  ">
                         
                        Modulo de Mensajería de DLDS Distribuidores
                    </p>
                    <p class="text-base text-gray-700">
                    Modulo que integra funcionalidades como:
                    <br>
                    - <strong>Mensajería a medida</strong>
                    <br>
                    - <strong>Margenes al listado de productos</strong>
                    <br>
                    - <strong>Dashboard para la vista de pedido</strong>
                    <br>
                    - <strong>Cálculo de descuentos aplicados al pedido</strong>
                    <br>
                    - <strong>Información relevante del pedido</strong>
                    <br>
                    <strong>Realizado por: Andrés Abarzúa</strong>
                    <br>
                    <strong>Version: v1.0.0</strong>
                    </p>
                </div>
